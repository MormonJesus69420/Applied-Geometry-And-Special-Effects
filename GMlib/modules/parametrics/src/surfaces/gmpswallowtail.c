...
//*****************************************
  ...
  template <typename T>
  void PSwallowTail<T>::eval(T u, T v, int d1, int d2, bool /*lu*/, bool /*lv*/ ) const {
  ...
  template <typename T>
  T PSwallowTail<T>::getStartPU() const {
    return -T(2);
  }


  template <typename T>
  T PSwallowTail<T>::getEndPU() const {
    return T(2);
  }


  template <typename T>
  T PSwallowTail<T>::getStartPV() const {
    return -T(0.8);
  }


  template <typename T>
  T PSwallowTail<T>::getEndPV() const {
    return T(0.8);
  }
